...
## developer packages ##
sudo apt install -y build-essential git pkg-config cmake zlib1g-dev libssl-dev libffi-dev libxcb1-dev libx11-dev libx11-xcb-dev libxrandr-dev libxinerama-dev libxft-dev autoconf automake libtool openjdk-17-jdk clangd wget curl zip
